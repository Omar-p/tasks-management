  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_outside: "day-outside text-muted opacity-50",
        day_disabled:
          "text-muted opacity-30 hover:bg-transparent cursor-not-allowed",
        day_range_middle: "aria-selected:bg-surface-alt",
